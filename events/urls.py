...
from events.views import events_dashboard, events_list, event_details, events,participants,categories, create_event, create_category,update_event,delete_event, update_category, delete_category, search_result, organizer_dashboard, participant_dashboard, dashboard
